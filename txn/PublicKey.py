...
if __name__ == '__main__':
    privkey_wif_l = ['KwfxnwxpPG1RmhU8jaU8Ron4m1KZGymLAFNaMnSTonoZ7AQfnV53', 'L26JcHRhqEQv8V9DaAmE4bdszwqXS7tHznGYJPp7fxEoEQxxBPcQ', 'L2R3rzLbZZBLdR7Rv7JmUhkagHgGJ1HtvKjdn8wmRoFMWQx4da3x', 'KxR8HHyfAwFPidCw2vXThXqT4vSMNeufirHFapnfCfkzLaohtujG', 'KyWeQEcM2YdirR2E7JwxSRjfgNuWyt4DR3v4sGtPvmeZqhTxWVrp', 'Ky5CYfpeMkfFku7K4FvzeEwRmTJhWqD2eFiMnjLT7uw2oUVMgyg6', 'L1cnATDVZyvuo9m6tprCmbr14vm3JeCbkc4Z2397ZM7P96N3d8GA', 'KyP1xynRgwrCUThXATVy5kbKqteAxisDFY74zrHozSGhb75hJ3M6', 'KxBhPZZFTY9Cks49wobjsrvkUyWcszKZefKGVvTMSBiTecusWris', 'L3mQ6zMk7vTpHSXD2WZdq7Aw289sPNHvyKvYhhK3Zdfe4kYd1hmg']
#    privkey_wif_l = ['cMnzN3AWTsEEa6cQ2efRVtVShDm9wEW7MJPFiGTLLL6Nx5cEnXqL', 'cVGJZGp7YbBsnGfVU6YKfGgT4cTsxt77Viyvq6W7ySgLzXqWRA2B', 'cVWuCEt85zke56C9uDjRmeRK3zW15mDXtvm4Xz3Z1ZuhnRHUKp7H']
#    privkey_wif_l = ['L2R3rzLbZZBLdR7Rv7JmUhkagHgGJ1HtvKjdn8wmRoFMWQx4da3x', 'KyWeQEcM2YdirR2E7JwxSRjfgNuWyt4DR3v4sGtPvmeZqhTxWVrp']
    arr = []
    for privkey_wif in privkey_wif_l:
        pubkey_b = privkeyWif2pubkey(privkey_wif)
        arr.append('"%s": "%s"' % (privkey_wif, pubkey_b.hex()))
    print("{" + ",".join(arr) + "}")
