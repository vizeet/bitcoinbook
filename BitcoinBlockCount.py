...
#
#        block_count = getBlockCount(jsonobj['n_file'])
#
#        # load file to memory
...
#        df1 = pd.DataFrame.from_records([blockheader])
#        df = df.append(df1)
#        if jsonobj['height'] == 1:
#            break
